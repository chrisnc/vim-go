...
if !exists("g:go_highlight_cgo")
  let g:go_highlight_cgo = 0
else
  " use Vim's C syntax to highlight cgo source, included here
  " so its rules have lower priority than the extra rules we will
  " use in the cgo region. see the cgo rules below for more info
